...
transformed parameters {
	...
	real rate_gen = shape_gen/mu_gen;
	real rate_inf = shape_inf/mu_inf;
	real rate_report = 1/mu_report;
...
model {
	...
	indR ~ lognormal(log(popR), sigmaR);
